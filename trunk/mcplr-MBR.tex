...
The learning model uses the feedback $y_t$ on trial $t$ to update its representation of the environment. This representation is generally the conditional distribution $P(Y_t|\vec{x}_t)$ that is formed by the learning model is abstracted as a set of parameters 
(e.g., the conditional distribution ) 
