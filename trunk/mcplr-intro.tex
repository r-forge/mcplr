...
Multiple cue probability learning tasks require the prediction of a criterion variable on the basis of a number of cues which are imperfectly related to the criterion. This class of task is quite general. A numerical criterion variable is often used in Social Judgement Theory. When the criterion is a nominal variable, it is also common to speak of category learning tasks. 
